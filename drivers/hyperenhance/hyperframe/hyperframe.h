...
#define HYPER_COMMON_IOCTL "common_ioctl"
...
enum FRAME_PUSH_TYPE {
	...
	HYPERFRAME_NOTIFIER_QOS_CANCEL,

	HYPERFRAME_NOTIFIER_COUNT,
};

enum COMMON_TYPE_ID {
	HYPERFRAME_COMMON_TYPE_ID_START = 0,
	HYPERFRAME_COMMON_QOS_CANCEL,

	HYPERFRAME_COMMON_TYPE_ID_MAX,
};
...
#define HYPER_IO_COMMON_QOS_CANCEL       _IOW('g', 1, unsigned long)
