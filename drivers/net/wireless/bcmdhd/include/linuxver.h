...
static inline 
int __kernel_does_not_allow_vfs_fsync(struct file *file,int datasync) {
	return -EPERM;
}
static inline 
struct dentry *__kernel_does_not_allow_dget_parent(struct dentry *dentry) {
	return ERR_PTR(-EPERM);
}
static inline 
void __kernel_does_not_allow_path_put(const struct path *path) {
...
#define vfs_fsync(a,b)  __kernel_does_not_allow_vfs_fsync(a,b)
#define dget_parent(a)  __kernel_does_not_allow_dget_parent(a)
#define path_put(a)  __kernel_does_not_allow_path_put(a)
#else
