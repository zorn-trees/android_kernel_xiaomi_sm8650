...
#ifdef DHD_43022
			if (!(sii->pub.chip == CYW43022_CHIP_ID &&
			    sih->secureboot == TRUE))
...
#ifdef DHD_43022
	if (CHIPID(sih->chip) == CYW43022_CHIP_ID) {
		sih->secureboot = !bcmsdh_cfg_read(sdh, SDIO_FUNC_1,
				SBSDIO_FUNC1_SECURE_MODE, NULL);
	}
#endif /* DHD_43022 */
...
#ifdef DHD_43022
	if (CHIPID(sih->chip) == CYW43022_CHIP_ID && sih->secureboot == TRUE) {
		/* Write access to SOCRAM is restricted */
		return CM3_43022C1_SRMEM_SZ;
	}
#endif /* DHD_43022 */
