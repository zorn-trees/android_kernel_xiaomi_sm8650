...
static int
wl_iw_config_commit_cfiwrapper(
	struct net_device *dev,
	struct iw_request_info *info,
...
{
	return wl_iw_config_commit(dev,info,zwrq,extra);
}
...
{
	return wl_iw_get_name(dev, info, cwrq, extra);
}
...
{
	return wl_iw_set_freq(dev, info, (struct iw_freq *)fwrq, extra);
}
...
{
	return wl_iw_get_freq(dev, info, (struct iw_freq *)fwrq, extra);
}
...
{
	return wl_iw_set_mode(dev, info, (__u32 *)uwrq, extra);
}
...
{
	return wl_iw_get_mode(dev, info, (__u32 *)uwrq, extra);
}
...
{
	return wl_iw_get_range(dev, info, (struct iw_point *)dwrq, extra);
}
...
{
	return wl_iw_set_spy(dev, info, (struct iw_point *)dwrq, extra);
}
...
{
	return wl_iw_get_spy(dev, info, (struct iw_point *)dwrq, extra);
}
...
{
	return wl_iw_set_wap(dev, info, (struct sockaddr *)awrq, extra);
}
...
{
	return wl_iw_get_wap(dev, info, (struct sockaddr *)awrq, extra);
}
...
{
	return wl_iw_mlme(dev, info, (struct sockaddr *)awrq, extra);
}
#endif /* WIRELESS_EXT > 17 */
...
static int
wl_iw_iscan_get_aplist_cfiwrapper(
	struct net_device *dev,
	struct iw_request_info *info,
	union iwreq_data *dwrq,
	char *extra
...
{
	return wl_iw_iscan_get_aplist(dev, info, (struct iw_point *)dwrq, extra);
}
...
static int
wl_iw_iscan_set_scan_cfiwrapper(
	struct net_device *dev,
	struct iw_request_info *info,
	union iwreq_data *wrqu,
	char *extra
...
{
	return wl_iw_iscan_set_scan(dev, info, wrqu, extra);
}
...
static int
wl_iw_iscan_get_scan_cfiwrapper(
	struct net_device *dev,
	struct iw_request_info *info,
	union iwreq_data *dwrq,
	char *extra
...
{
	return wl_iw_iscan_get_scan(dev, info, (struct iw_point *)dwrq, extra);
}
...
{
	return wl_iw_set_essid(dev, info, (struct iw_point *)dwrq, extra);
}
...
{
	return wl_iw_get_essid(dev, info, (struct iw_point *)dwrq, extra);
}
...
{
	return wl_iw_set_nick(dev, info, (struct iw_point *)dwrq, extra);
}
...
{
	return wl_iw_get_nick(dev, info, (struct iw_point *)dwrq, extra);
}
...
static int wl_iw_set_rate_cfiwrapper(
	struct net_device *dev,
	struct iw_request_info *info,
	union iwreq_data *vwrq,
	char *extra
)
{
	return wl_iw_set_rate(dev, info, (struct iw_param *)vwrq, extra);
}
...
static int wl_iw_get_rate_cfiwrapper(
	struct net_device *dev,
	struct iw_request_info *info,
	union iwreq_data *vwrq,
	char *extra
...
{
	return wl_iw_get_rate(dev, info, (struct iw_param *)vwrq, extra);
}
...
{
	return wl_iw_set_rts(dev, info, (struct iw_param *)vwrq, extra);
}
...
{
	return wl_iw_get_rts(dev, info, (struct iw_param *)vwrq, extra);
}
...
{
	return wl_iw_set_frag(dev, info, (struct iw_param *)vwrq, extra);
}
...
{
	return wl_iw_get_frag(dev, info, (struct iw_param *)vwrq, extra);
}
...
{
	return wl_iw_set_txpow(dev, info, (struct iw_param *)vwrq, extra);
}
...
{
	return wl_iw_get_txpow(dev, info, (struct iw_param *)vwrq, extra);
}
...
{
	return wl_iw_set_retry(dev, info, (struct iw_param *)vwrq, extra);
}
...
{
	return wl_iw_get_retry(dev, info, (struct iw_param *)vwrq, extra);
}
#endif /* WIRELESS_EXT > 10 */
...
{
	return wl_iw_set_encode(dev, info, (struct iw_point *)dwrq, extra);
}
...
{
	return wl_iw_get_encode(dev, info, (struct iw_point *)dwrq, extra);
}
...
{
	return wl_iw_set_power(dev, info, (struct iw_param *)vwrq, extra);
}
...
{
	return wl_iw_get_power(dev, info, (struct iw_param *)vwrq, extra);
}
...
static int
wl_iw_set_wpaie_cfiwrapper(
	struct net_device *dev,
	struct iw_request_info *info,
	union iwreq_data *iwp,
	char *extra
)
{
	return wl_iw_set_wpaie(dev, info, (struct iw_point *)iwp, extra);
}
...
{
	return wl_iw_get_wpaie(dev, info, (struct iw_point *)iwp, extra);
}
...
static int
wl_iw_set_encodeext_cfiwrapper(
	struct net_device *dev,
	struct iw_request_info *info,
	union iwreq_data *dwrq,
	char *extra
...
{
	return wl_iw_set_encodeext(dev, info, (struct iw_point *)dwrq, extra);
}
...
{
	return wl_iw_set_pmksa(dev, info, (struct iw_param *)vwrq, extra);
}
#endif /* WIRELESS_EXT > 17 */
...
static int
wl_iw_get_encodeext_cfiwrapper(
	struct net_device *dev,
	struct iw_request_info *info,
	union iwreq_data *vwrq,
	char *extra
...
{
	return wl_iw_get_encodeext(dev, info, (struct iw_param *)vwrq, extra);
}
...
{
	return wl_iw_set_wpaauth(dev, info, (struct iw_param *)vwrq, extra);
}
...
{
	return wl_iw_get_wpaauth(dev, info, (struct iw_param *)vwrq, extra);
}
#endif /* WIRELESS_EXT > 17 */

static const iw_handler wl_iw_handler[] =
{
	(iw_handler) wl_iw_config_commit_cfiwrapper,/* SIOCSIWCOMMIT */
	(iw_handler) wl_iw_get_name_cfiwrapper,		/* SIOCGIWNAME */
	(iw_handler) NULL,			/* SIOCSIWNWID */
	(iw_handler) NULL,			/* SIOCGIWNWID */
	(iw_handler) wl_iw_set_freq_cfiwrapper,		/* SIOCSIWFREQ */
	(iw_handler) wl_iw_get_freq_cfiwrapper,		/* SIOCGIWFREQ */
	(iw_handler) wl_iw_set_mode_cfiwrapper,		/* SIOCSIWMODE */
	(iw_handler) wl_iw_get_mode_cfiwrapper,		/* SIOCGIWMODE */
	(iw_handler) NULL,			/* SIOCSIWSENS */
	(iw_handler) NULL,			/* SIOCGIWSENS */
	(iw_handler) NULL,			/* SIOCSIWRANGE */
	(iw_handler) wl_iw_get_range_cfiwrapper,		/* SIOCGIWRANGE */
	(iw_handler) NULL,			/* SIOCSIWPRIV */
	(iw_handler) NULL,			/* SIOCGIWPRIV */
	(iw_handler) NULL,			/* SIOCSIWSTATS */
	(iw_handler) NULL,			/* SIOCGIWSTATS */
	(iw_handler) wl_iw_set_spy_cfiwrapper,		/* SIOCSIWSPY */
	(iw_handler) wl_iw_get_spy_cfiwrapper,		/* SIOCGIWSPY */
	(iw_handler) NULL,			/* -- hole -- */
	(iw_handler) NULL,			/* -- hole -- */
	(iw_handler) wl_iw_set_wap_cfiwrapper,		/* SIOCSIWAP */
	(iw_handler) wl_iw_get_wap_cfiwrapper,		/* SIOCGIWAP */
#if WIRELESS_EXT > 17
	(iw_handler) wl_iw_mlme_cfiwrapper,		/* SIOCSIWMLME */
#else
	(iw_handler) NULL,			/* -- hole -- */
#endif // endif
	(iw_handler) wl_iw_iscan_get_aplist_cfiwrapper,	/* SIOCGIWAPLIST */
#if WIRELESS_EXT > 13
	(iw_handler) wl_iw_iscan_set_scan_cfiwrapper,	/* SIOCSIWSCAN */
	(iw_handler) wl_iw_iscan_get_scan_cfiwrapper,	/* SIOCGIWSCAN */
#else	/* WIRELESS_EXT > 13 */
	(iw_handler) NULL,			/* SIOCSIWSCAN */
	(iw_handler) NULL,			/* SIOCGIWSCAN */
#endif	/* WIRELESS_EXT > 13 */
	(iw_handler) wl_iw_set_essid_cfiwrapper,		/* SIOCSIWESSID */
	(iw_handler) wl_iw_get_essid_cfiwrapper,		/* SIOCGIWESSID */
	(iw_handler) wl_iw_set_nick_cfiwrapper,		/* SIOCSIWNICKN */
	(iw_handler) wl_iw_get_nick_cfiwrapper,		/* SIOCGIWNICKN */
	(iw_handler) NULL,			/* -- hole -- */
	(iw_handler) NULL,			/* -- hole -- */
	(iw_handler) wl_iw_set_rate_cfiwrapper,		/* SIOCSIWRATE */
	(iw_handler) wl_iw_get_rate_cfiwrapper,		/* SIOCGIWRATE */
	(iw_handler) wl_iw_set_rts_cfiwrapper,		/* SIOCSIWRTS */
	(iw_handler) wl_iw_get_rts_cfiwrapper,		/* SIOCGIWRTS */
	(iw_handler) wl_iw_set_frag_cfiwrapper,		/* SIOCSIWFRAG */
	(iw_handler) wl_iw_get_frag_cfiwrapper,		/* SIOCGIWFRAG */
	(iw_handler) wl_iw_set_txpow_cfiwrapper,		/* SIOCSIWTXPOW */
	(iw_handler) wl_iw_get_txpow_cfiwrapper,		/* SIOCGIWTXPOW */
#if WIRELESS_EXT > 10
	(iw_handler) wl_iw_set_retry_cfiwrapper,		/* SIOCSIWRETRY */
	(iw_handler) wl_iw_get_retry_cfiwrapper,		/* SIOCGIWRETRY */
#endif /* WIRELESS_EXT > 10 */
	(iw_handler) wl_iw_set_encode_cfiwrapper,		/* SIOCSIWENCODE */
	(iw_handler) wl_iw_get_encode_cfiwrapper,		/* SIOCGIWENCODE */
	(iw_handler) wl_iw_set_power_cfiwrapper,		/* SIOCSIWPOWER */
	(iw_handler) wl_iw_get_power_cfiwrapper,		/* SIOCGIWPOWER */
#if WIRELESS_EXT > 17
	(iw_handler) NULL,			/* -- hole -- */
	(iw_handler) NULL,			/* -- hole -- */
	(iw_handler) wl_iw_set_wpaie_cfiwrapper,		/* SIOCSIWGENIE */
	(iw_handler) wl_iw_get_wpaie_cfiwrapper,		/* SIOCGIWGENIE */
	(iw_handler) wl_iw_set_wpaauth_cfiwrapper,		/* SIOCSIWAUTH */
	(iw_handler) wl_iw_get_wpaauth_cfiwrapper,		/* SIOCGIWAUTH */
	(iw_handler) wl_iw_set_encodeext_cfiwrapper,	/* SIOCSIWENCODEEXT */
	(iw_handler) wl_iw_get_encodeext_cfiwrapper,	/* SIOCGIWENCODEEXT */
	(iw_handler) wl_iw_set_pmksa_cfiwrapper,		/* SIOCSIWPMKSA */
#endif /* WIRELESS_EXT > 17 */
};
...
enum {
	...
	WL_IW_SET_PM,
#ifdef SSR_TEST_CMD
	WL_IW_SET_HANGTGR,// ssr trigger for test
#endif
#if WIRELESS_EXT > 17
#endif /* WIRELESS_EXT > 17 */
	WL_IW_SET_LAST
